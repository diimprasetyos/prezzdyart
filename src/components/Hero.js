		...
		<section className="flex items-center hero">
			<div className="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
				<h1 className="text-3xl md:text-5xl leading-tight font-semibold">
					Unlocking Excellence, <br className="" />
					Good Art at a Time
				</h1>
				<h2 className="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
					Kami menyediakan Aksesoris & Piala berkelas
					<br className="hidden lg:block" />
					untuk berbagai macam event anda.
				</h2>
				<div>
					<a
						href="#browse-the-room"
						className="bg-sky-200 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">
						Explore Now
					</a>
				</div>
			</div>
			<div className="w-full inset-0 md:relative md:w-1/2">
				<div className="relative hero-image">
					...
					<img
						src="images/content/image-section-2.png"
						alt="hero 1"
