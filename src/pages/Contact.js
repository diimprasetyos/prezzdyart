				...
				<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
					...
					<div class="mx-auto max-w-2xl text-center">
						...
						<p class="mt-2 text-lg leading-8 text-gray-600">
							Isikan data dibawah ini untuk menghubungi kami lebih lanjut.
						</p>
					</div>
					<form
						action="#"
						...
						<div class="grid grid-cols-1 gap-x-8 gap-y-auto sm:grid-cols-2">
							<div>
								<label
									for="first-name"
							...
							<div class="sm:col-span-2">
								...
								<div class="relative mt-2.5">
									...
									<input
										...
										id="phone-number"
										autocomplete="tel"
										class="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></input>
								</div>
							</div>
							<div class="sm:col-span-2">
								<label
